...
#define		JMP	4
#define		JMZ	5
#define		JMN	6		/* #define	JMG	6 */
#define		DJN	7		/* #define	DJZ	7 */
#define		CMP	8
#define		SPL	9
#define		DAT	0
...
#define DIRECT		1
#define INDIRECT	2
#define PDINDIRECT	3		/* Pre-Decrement Indirect Mode */
...
#define	MAXPROCNUM	64	/* max no of processes at top level */
